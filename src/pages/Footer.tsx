...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0a0a0a] border-t border-white/10 py-8 sm:py-12 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          <span className="text-lg sm:text-xl tracking-wide mb-1" style={{ fontFamily: "'Dancing Script', cursive", fontWeight: 600 }}>Ian</span>
          <p className="text-xs sm:text-sm text-gray-500">Building digital experiences.</p>
        </div>

        <div className="flex items-center gap-5 sm:gap-6 my-2 md:my-0">
        ...
        <div className="text-xs sm:text-sm text-gray-500 flex flex-col items-center md:items-end text-center md:text-right">
          <p>&copy; {currentYear} All rights reserved.</p>
          <p className="mt-0.5 sm:mt-1 flex items-center gap-1">
